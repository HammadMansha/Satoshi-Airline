...
class CheckIn extends StatelessWidget {
  ...
  List<Widget> bodyPages(CheckInController _, BuildContext context) {
    return [testFlightTab(_, context), const BasicTabScreen(), QrScreen()];
  }

  Widget testFlightTab(CheckInController _, BuildContext context) {
  ...
  Widget checkIn(CheckInController _, BuildContext context) {
  ...
  Widget tabbarCustom(CheckInController _, BuildContext context) {
    return Container(
      height: 50,
      width: Get.width,
      decoration: BoxDecoration(
  ...
  Widget btnStack(btnText, boolean, CheckInController _) {
    return btn(
      onTap: () {
