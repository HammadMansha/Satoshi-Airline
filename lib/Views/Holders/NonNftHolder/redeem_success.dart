...
import 'package:satoshi/Controllers/redeemSuccess_controller.dart';
...
class RedeemSuccess extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<RedeemSuccessController>(
      init: RedeemSuccessController(),
      builder: (_) {
        return WillPopScope(
          onWillPop: () async {
            return false;
  ...
  Widget body(BuildContext context, RedeemSuccessController _) {
    return Container(
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            _.landingPageController.minitingGlobleController
                                .update();
                            await _
                                .landingPageController.minitingGlobleController
                                .getUserNftData();
