...
import 'package:satoshi/Controllers/wallet/sending_coins/send_usdt_controller.dart';
...
class SendToUsdtScreen extends StatelessWidget {
  const SendToUsdtScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SendUsdtCoinController>(
        init: SendUsdtCoinController(),
        builder: (_) {
          return MediaQuery(
            data: mqDataNew,
            child: Scaffold(
