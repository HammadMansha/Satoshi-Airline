...
import 'package:satoshi/Views/free_jeets/total_minting_ferry/total_minting_ferry_controller.dart';
...
class TotalMintingFerryScreen extends StatelessWidget {
  const TotalMintingFerryScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<TotalMintingFerryController>(
      init: TotalMintingFerryController(),
      builder: (_) {
        return WillPopScope(
          ...
          child: MediaQuery(
            ...
            child: Scaffold(
              ...
              body: _.isLoading ? LevelEffect() : testFlightTab(_, context),
  ...
  Widget testFlightTab(TotalMintingFerryController _, BuildContext context) {
    return Column(
      children: [
        Expanded(
          child: Container(
                                ...
                                child: Text(
                                  '${double.parse((double.parse(
                                      ...
                                      (_.usernftData['attribuets']['fuel'])
                                          .toString())).toString())
                                      .toStringAsFixed(2)}/${double.parse((_
                                      .nftData['attributes']['fuel']['maxValue'])
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: LinearPercentIndicator(
                                            ...
                                            percent: _.calValue(_
                                                .usernftData['attribuets']['fuel'],
                                                _
                                                    .nftData['attributes']['fuel']['value']) >
                                                1.0 ||
                                                _.calValue(
                                ...
                                child: Text(
                                  '${double.parse((double.parse(
                                      ...
                                      (_.usernftData['attribuets']['mine'])
                                          .toString())).toString())
                                      .toStringAsFixed(2)}/${double.parse((_
                                      .nftData['attributes']['mine']['maxValue'])
                                      .toString()).toStringAsFixed(2)}',
                                  style: attributesValueStyle,
                                ),
                              ),
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: LinearPercentIndicator(
                                            ...
                                            padding: const EdgeInsets.all(0.0),
                                            percent: _.calValue(_
                                                .usernftData['attribuets']['mine'],
                                                _
                                                    .nftData['attributes']['mine']['value']) >
                                                1.0 ||
                                                _.calValue(
                                                    _.usernftData['attribuets']
                                                    ['mine'],
                          ...
                          Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                  '${double.parse((double.parse(
                                      (_.nftData['attributes']['luck']['value'])
                                          .toString()) - double.parse(
                                      (_.usernftData['attribuets']['luck'])
                                          .toString())).toString())
                                      .toStringAsFixed(2)}/${double.parse((_
                                      .nftData['attributes']['luck']['maxValue'])
                                      .toString()).toStringAsFixed(2)}',
                                  style: attributesValueStyle,
                                ),
                              ),
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: LinearPercentIndicator(
                                            ...
                                            padding: const EdgeInsets.all(0.0),
                                            percent: _.calValue(_
                                                .usernftData['attribuets']['luck'],
                                                _
                                                    .nftData['attributes']['luck']['value']) >
                                                1.0 ||
                                                _.calValue(
                                                    _.usernftData['attribuets']
                                                    ['luck'],
  ...
  Widget tabbarCustom(TotalMintingFerryController _, BuildContext context) {
    return Container(
      height: 50,
      width: Get.width,
      decoration: BoxDecoration(
  ...
  Widget btnStack(btnText, boolean, BuildContext context,
      TotalMintingFerryController _) {
