...
import '../arrival_ferry_jets/arrival_ferry_jet.dart';
import 'fly_to_earn_ferry_controller.dart';

class FlyToEarnFerry extends StatelessWidget {
  const FlyToEarnFerry({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery(
      data: mqDataNew,
      child: GetBuilder<FlyToEarnFerryController>(
        init: FlyToEarnFerryController(),
        builder: (_) {
          return WillPopScope(
            onWillPop: () async {
              return true;
  ...
  Widget body(FlyToEarnFerryController _) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Container(
            child: Text(
              'To ger reward. please tap on redeem when you got the notification from Satoshi Airlines',
