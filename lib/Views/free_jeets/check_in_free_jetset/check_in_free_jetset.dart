...
import 'check_in_free_controller.dart';

class CheckInferryJet extends StatelessWidget {
  const CheckInferryJet({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CheckInFerryJetController>(
      init: CheckInFerryJetController(),
      builder: (_) {
        return MediaQuery(
          data: mqDataNew,
          child: Scaffold(
            ...
            body: _.isLoading ? CheckinEffect() : testFlightTab(_, context),
          ),
        );
      },
    );
  ...
  Widget testFlightTab(CheckInFerryJetController _, BuildContext context) {
        ...
        children: [
          ...
          Align(
              ...
              child: InkWell(
                  ...
                  child: Image.asset(AppConstants.ferryDialogBox, height: 28)
                      .marginOnly(
                    right: 25,
                  ))),
          Row(
  ...
  Widget tabbarCustom(CheckInFerryJetController _, BuildContext context) {
    return Container(
      height: 50,
      width: Get.width,
      decoration: BoxDecoration(
  ...
  Widget btnStack(btnText, boolean, CheckInFerryJetController _) {
    return btn(
      onTap: () {
        Get.toNamed(Routes.flytoearnFerryRoutes);
        // _.playSoundEffect();
